/**
 * @file
 * @brief vendor device class - device info.
 * @internal
 *
 ...
 *
 * @details Definitions of the vendor device class for the device info.
 * @{
 */
#pragma once
...
/** vendor device control request handler for the device info interface
 *
