 ...
 *
 * @details Definitions of the vendor device class for the LIN communication interface.
 * @{
 */
#pragma once
...
/** vendor device control request handler for the LIN communication interface
 *
