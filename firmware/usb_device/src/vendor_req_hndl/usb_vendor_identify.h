 ...
 *
 * @details Definitions of the vendor device class for the device identification interface.
 * @{
 */
#pragma once
...
/** vendor device control request handler for the device identification interface
 *
