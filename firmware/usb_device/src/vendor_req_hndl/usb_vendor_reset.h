/**
 * @file
 * @brief vendor device class - device reset interface.
 * @internal
 *
 ...
 *
 * @details Definitions of the vendor device class for the device reset interface.
 * @{
 */
#pragma once
...
/** vendor device control request handler for the device reset interface
 *
 ...
 */
bool vendor_handle_class_control_request_reset(uint8_t rhport,
                                               uint8_t stage,
