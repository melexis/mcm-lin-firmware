 ...
 *
 * @details Definitions of the vendor device class for the slave power control interface.
 * @{
 */
#pragma once
...
/** vendor device control request handler for the slave power control interface
 *
