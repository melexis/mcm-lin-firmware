 ...
 *
 * @details Definitions of the vendor device class for the intelhex transfer interface.
 * @{
 */
#pragma once
...
/** vendor device control request handler for the intelhex transfer interface
 *
...
/** get a pointer to the currently available intelhex container
 *
 * @returns  pointer to current container.
 */
